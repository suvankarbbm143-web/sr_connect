...
def sr_coa_search_batch(batch_no, product_coa=1, application_coa=0):
    ...
    # -----------------------------------------------------
    # Batch No search is case-insensitive.
    # Example: b242d / B242D / B242d all find the same Batch.
    batch_rows = frappe.get_all(
        "Batch",
        filters={
            "name": ["like", batch_no],
    ...
    for row in qi_rows:
        ...
        # Older completed Application inspections may have
        # custom_qc_inspection_type = None.
        # If Application COA is ON, expose that completed QI
        # as Application COA.
        elif not category and application_enabled:
